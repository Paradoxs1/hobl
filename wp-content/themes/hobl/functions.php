...
function hobl_setup() {
	load_theme_textdomain( 'hobl', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
	  ...
	  'footer_contact' => 'Социальные сети в footer',
      'header_contact' => 'Социальные сети в header',
	 ) );
	...
	add_theme_support( 'custom-background', apply_filters( 'hobl_custom_background_args', array(
...
add_action( 'after_setup_theme', 'hobl_setup' );

function hobl_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'hobl_content_width', 640 );
}
add_action( 'after_setup_theme', 'hobl_content_width', 0 );

function hobl_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'hobl' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'hobl' ),
...
add_action( 'widgets_init', 'hobl_widgets_init' );

function hobl_style() {
    wp_enqueue_style( 'slick', get_template_directory_uri() . '/css/slick.css');
    wp_enqueue_style( 'slick-theme', get_template_directory_uri() . '/css/slick-theme.css');
    wp_enqueue_style( 'hobl-style', get_stylesheet_uri() );
}
add_action( 'wp_enqueue_scripts', 'hobl_style' );

function hobl_scripts() {
...
add_action( 'wp_enqueue_scripts', 'hobl_scripts' );
...
function kama_pagenavi( $before = '', $after = '', $echo = true, $args = array(), $wp_query = null ) {
	...
	$default_args = array(
		...
		'step_link'       => 5, // ссылки с шагом (значение - число, размер шага (пр. 1,2,3...10,20,30). Ставим 0, если такие ссылки не нужны.
