...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    'contextual_help' => array( 
      'content'       => array( 
        array(
          ...
          'title'     => 'Teremok',
          'content'   => '<p>' . 'Настройки шаблона темы!' . '</p>'
        )
      ),
    ...
    'settings'        => array( 
      ...
      array(
        'id'          => 'main-section',
        'label'       => 'Раздел под шапкой сайта на главной странице',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'home'
      ),
      array(
        'id'          => 'section-text',
        'label'       => 'Текст справа от картинки',
        'desc'        => '',
        'std'         => '',
        'type'        => 'textarea-simple',
        'section'     => 'home',
      ...
      array(
        'id'          => 'section-text2',
        'label'       => 'Текст под заголовком (первый абзац)',
        'desc'        => '',
        'std'         => '',
        'type'        => 'textarea-simple',
        'section'     => 'home',
      ...
      array(
        'id'          => 'section-text3',
        'label'       => 'Текст под заголовком (второй абзац)',
        'desc'        => '',
        'std'         => '',
        'type'        => 'textarea-simple',
        'section'     => 'home',
